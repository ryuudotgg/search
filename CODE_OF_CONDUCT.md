...
- Ignoring established code quality standards and type safety requirements
- Deliberately introducing technical debt without justification
...
This Code of Conduct is adapted from the [Contributor Covenant][homepage], version [2.1][v2.1].

Community Impact Guidelines were inspired by [Mozilla's Code of Conduct][Mozilla CoC].
