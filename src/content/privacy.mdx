...
**We do not store your search queries.** When you use our Services:
...
Our Services provide a feature called "bangs" that allows you to perform searches on third-party websites directly. When you enter a query followed by a special syntax (e.g., "!g" for Google, "!w" for Wikipedia, "!gh" for GitHub), our Services redirect you to the corresponding third-party website with your search query.
...
::item[your search query is sent directly to the third-party website you are redirected to;]{index="3.2.1"}
...
We recommend reviewing the privacy policies of any third-party websites you visit through our Services' bang redirects.
